...
public class D_TimerEnergySource {
	...
	public static D_TimerEnergySource create() {
		final D_TimerEnergySource energySource = new D_TimerEnergySource();
		energySource.init();
		return energySource;
	}
	...
	public void testCorrectWork() throws InterruptedException{
		...
		final D_TimerEnergySource[] sources = new D_TimerEnergySource[number_of_sources];
		for(int i=0; i<100; i++)
			sources[i] = D_TimerEnergySource.create();
		
		for(final D_TimerEnergySource source : sources){
