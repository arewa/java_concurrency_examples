...
public class G_AccessingMap {
  ...
  public void testConcurrentAccess() throws InterruptedException {
    ...
    assertEquals("Using Synchronized HashMap", ___, useMap(Collections.synchronizedMap(new HashMap<String, Integer>())));

    assertEquals("Using Concurrent HashMap", ___, useMap(new ConcurrentHashMap<String, Integer>()));      
  }
}
